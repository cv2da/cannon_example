...
/*-----------------------------------------------
              @(target):= _m01de4b73b37ffd19b14d65fceb70cfbd.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__m01de4b73b37ffd19b14d65fceb70cfbd

#else
#  define SWIG_init    init_m01de4b73b37ffd19b14d65fceb70cfbd

#endif
#define SWIG_name    "_m01de4b73b37ffd19b14d65fceb70cfbd"
...
SWIGINTERN PyObject *_wrap_cannon_analytic(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  result = (int)cannon_analytic(arg1);
  {
    // INT OUT
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "cannon_analytic", _wrap_cannon_analytic, METH_O, NULL},
	 { NULL, NULL, 0, NULL }
};
